<?php
  ...
  define('AUTH_PASS','rP7_E85rJ_QpVfMN');

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //  Database
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  define('MYSQL_HOST', 'p3plcpnl0831.prod.phx3.secureserver.net');
  define('MYSQL_DATABASE', 'previewavemaria1');
  define('MYSQL_USER', 'previewavemaria1');
  define('MYSQL_PASSWORD', 'g7KRDCXQyDbb!32r');
  ...
  //  Integrations
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  define('ALPHA_VANTAGE_KEY', '717O8Z3TDVG11DH2'); // +amdev
